...
export const LEVELS: LevelConfig[] = [
  ...
  { name: 'The Angler', env: 'lair', depth: 160, pearlsNeeded: 4, counts: { pearl: 4, mine: 8, jelly: 0, fish: 2, tank: 2, powerups: 2 }, pingMax: 240, drain: 3.4, currents: 0, boss: 'angler', bossHp: 3, intro: 'Something big hunts your pings. Lure it into the mines.' },
  ...
  { name: 'The Kraken', env: 'kraken', depth: 280, pearlsNeeded: 5, counts: { pearl: 4, mine: 9, jelly: 0, fish: 2, tank: 2, powerups: 3 }, pingMax: 230, drain: 3.6, currents: 0, boss: 'kraken', bossHp: 4, intro: 'It strikes where you ping. Ping next to the mines. Then move.' },
